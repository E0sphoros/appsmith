...
module.exports = {
  ...
  transformIgnorePatterns: [
    "<rootDir>/node_modules/(?!codemirror|design-system-old|react-dnd|dnd-core|@babel|@blueprintjs|@github|lodash-es|@draft-js-plugins|react-documents|linkedom|assert-never)",
  ],
  moduleNameMapper: {
